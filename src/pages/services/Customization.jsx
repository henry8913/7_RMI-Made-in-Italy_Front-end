    ...
    <div className="min-h-screen bg-secondary-950">
      ...
      <div className="relative h-[60vh] md:h-[70vh]">
        <div className="absolute inset-0 z-0">
          ...
          <img
            src="https://images.pexels.com/photos/13121026/pexels-photo-13121026.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
        ...
        <div className="relative z-20 h-full flex items-center">
          <div className="container-custom">
            ...
            >
              Trasforma la tua auto classica in un'opera d'arte unica, combinando estetica vintage e tecnologia moderna.
            </motion.p>
          </div>
        </div>
      </div>
