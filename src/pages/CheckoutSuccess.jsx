              ...
              <div className="bg-secondary-800/30 rounded-lg p-6 mb-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <p>{`${order.customer.address}, ${order.customer.postalCode} ${order.customer.city}, ${order.customer.country}`}</p>
                  </div>
                </div>
              </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-secondary-400">
                            {item.type === 'restomod' ? 'Restomod' : 'Pacchetto'} x {item.quantity}
                          </p>
                        </div>
                      </div>
                ...
                <div className="w-full md:w-1/2">
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span>{formatPrice(order.total / 1.22)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-secondary-300">IVA (22%)</span>
                      <span>{formatPrice(order.total - (order.total / 1.22))}</span>
                    </div>
